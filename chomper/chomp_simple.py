...
@cached
def get_trained_model(norm_xtrain: Union[np.ndarray, tf.Tensor],
    ...
    keras.utils.plot_model(model, to_file=f'output/chomp_simple.model.png')
...
if __name__ == '__main__':
    ...
    model, history = get_trained_model(norm_xtrain, ytrain)
